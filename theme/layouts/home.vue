  ...
  <BaseLayout :page="page">
    <div v-for="(post, i) in featuredPosts" :key="post.attributes.slug">
      <div class="w-full mb-6">
        ...
        <p class="text-grey-darker font-medium my-2">{{ date(post.attributes.createdAt) }}</p>
    ...
    <div v-for="(posts, i) in unfeaturedPosts" :key="i">
      <div class="flex flex-col md:flex-row md:-mx-6">
        <div class="w-full md:w-1/2 md:mx-6" v-for="post in posts" :key="post.attributes.slug">
